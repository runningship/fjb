...
function layerShowBox(id){
      ...
      function LayerRemoveBox(id){
   	 ...
   	 function openNewWin(id,s){
		 
			 
			 var htmlText = '<div class="maskLayer"></div><div class="cocoLayer" id=' + id + ' style="width:600px; height:480px; display:block;"><div class="cocoLayerTit" ><span>预约看房</span><i class="closeBg close" onclick="LayerRemoveBox(\''+id+'\')" title="关闭">×</i></div><iframe frameborder="0" src="'+s+'" style="width:100%;border:0px;height:440px;"></iframe></div>';
