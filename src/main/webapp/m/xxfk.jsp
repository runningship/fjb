...
<input type="hidden" name="orderId" value="${order.id}"/>
  <tr>
    <td height="25" width="80" bgcolor="#eeeeee" class="t">客户姓名:</td>
    <td>${order.buyerName}</td>
  </tr>
  <tr>
    <td width="80" bgcolor="#eeeeee" class="t">联系电话:</td>
    <td>${order.buyerTel}</td>
  </tr>
  <tr>
    <td height="25" width="80" bgcolor="#eeeeee" class="t">预约楼盘:</td>
    <td>${estate.name} <c:if test="${house.dhao!=null && house.fhao!=null}">${house.dhao}#${house.fhao}</c:if></td>
  </tr>
  <tr>
    <td width="80" bgcolor="#eeeeee" class="t">预约时间:</td>
    <td><fmt:formatDate value="${order.addtime}" pattern="yyyy-MM-dd HH-mm"/></td>
  </tr>
  <tr>
    <td width="80" bgcolor="#eeeeee" class="t">状态:</td>
    <td>${order.status}</td>
  </tr>
<!--   <tr> -->
<!--     <td height="25" width="80" bgcolor="#eeeeee" class="t" valign="top"><span style="display:block; list-style:25px; margin-top:3px;">备注:</span></td> -->
...
<!--   </tr> -->
  <tr>
    <td height="25" width="80" bgcolor="#eeeeee" class="t" valign="top"><span style="display:block; list-style:25px; margin-top:3px;">添加跟进:</span></td>
